...
import com.jfatty.zcloud.alipay.service.AlipayTextDealInterfaceService;
...
public class InAlipayAsyncMsgSendExecutor implements ActionExecutor {
    ...
    @Override
    public String execute(AlipayConfig config) {
        //取得发起请求的支付宝账号id
        ...
        executors.execute(new Runnable() {
            ...
            public void run() {
                try {
                  ...
                  //update-begin--author:zhangjiaqiang Date:20161108 for:#1487 【开源项目】开源支付窗服务窗单公众号项目
                    AlipayClient alipayClient = AlipayClientFactory.getAlipayClientInstance(config);
                  //update-end--author:zhangjiaqiang Date:20161108 for:#1487 【开源项目】开源支付窗服务窗单公众号项目
