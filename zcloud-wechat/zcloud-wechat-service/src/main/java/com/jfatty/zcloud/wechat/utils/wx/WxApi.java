...
import com.jfatty.zcloud.wechat.utils.HttpClientUtils;
import com.jfatty.zcloud.wechat.utils.MyTrustManager;
...
public class WxApi implements Serializable {
    ...
    /**
     * 获取图文分享转发数据
     * {@link http://mp.weixin.qq.com/wiki?t=resource/res_main&id=mp1421141084}
     * @param accessToken
     * @param start
     * @param end
     * @return
