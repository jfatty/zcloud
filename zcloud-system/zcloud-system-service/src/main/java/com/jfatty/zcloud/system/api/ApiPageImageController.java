...
public class ApiPageImageController  extends ApiBaseSystemController<PageImage,PageImageReq,PageImageRes>  implements IPageImage {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "pageId", value = "页面ID 每个应用的每个前端页面系统都会分配一个ID作为唯一标志",dataType = "String",required = true,defaultValue = "DDDDDGRGRa60d2685379")
    })
    @RequestMapping(value={"/index"},method=RequestMethod.GET)
    public RETResultUtils<PageImageRes> index(@RequestParam(value = "appId" , defaultValue = "wxe3336a60d2685379" ) String appId  ,
                                              @RequestParam(value = "pageId" , defaultValue = "DDDDDGRGRa60d2685379") String pageId ){
