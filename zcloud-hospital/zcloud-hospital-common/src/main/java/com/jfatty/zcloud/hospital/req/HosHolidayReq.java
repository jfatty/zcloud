...
import com.jfatty.zcloud.hospital.dto.HosHolidayDTO;
 ...
 */
@Data
@ApiModel(description = "节假日检测请求实体")
public class HosHolidayReq extends HosHolidayDTO<HosHolidayReq> {
    ...
    @ApiModelProperty(name = "checkTime", position = 0,required = true, value = "被检测日期字符串" ,example = "2019-12-15" ,allowableValues = "yyyy-MM-dd")
