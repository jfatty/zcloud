 ...
 */
@Data
@TableName("stad_an_radio")
public class AnRadio extends Model<AnRadio> {
    ...
    public AnRadio(String id, String belongAnswerId, String belongId, String otherText, String quId, String quItemId, String customize) {
        this.id = id;
