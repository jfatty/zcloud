...
public class HOSPageSettingsRes extends HOSPageSettingsDTO<HOSPageSettingsRes> {
     ...
     * 医院logo二进制文件
     */
    @ApiModelProperty(name = "hosLogoImg", position = 1, required = true, value = "医院logo二进制文件" )
    private byte[] hosLogoImg;
    /**
     * 电话图标二进制文件
     */
    @ApiModelProperty(name = "addressIconImg", position = 1, required = true, value = "电话图标二进制文件" )
    private byte[] addressIconImg;
    /**
     * 电话图标二进制
     */
    @ApiModelProperty(name = "phoneIconImg", position = 1, required = true, value = "电话图标二进制" )
    private byte[] phoneIconImg;

    /**
     * 域值
     */
    @ApiModelProperty(name = "realm", position = 1, required = true, value = "域值" , example = "sdsdsd454548548787s8ds4d8as4")
