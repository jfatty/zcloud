...
import com.jfatty.zcloud.hospital.dto.ComplexPatientDTO;
 ...
 */
@Data
@ApiModel(description = "就诊人请求实体")
public class ComplexPatientReq extends ComplexPatientDTO<ComplexPatientReq> {
