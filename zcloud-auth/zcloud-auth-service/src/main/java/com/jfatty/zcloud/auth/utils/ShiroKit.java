...
import com.jfatty.zcloud.auth.constants.Constants;
...
public class ShiroKit {
    ...
    public static String md5(String credentials, String saltSource) {
        ...
        return new SimpleHash(Constants.ALGORITHM_NAME, credentials, ByteSource.Util.bytes(saltSource), Constants.HASH_ITERATIONS).toHex();
    }
